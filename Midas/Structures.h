...
typedef NTSTATUS(__stdcall *ZWDEVICEIOCONTROLFILE)(
...
typedef struct _KERNEL_SET_TARGET_REQUEST
{
	ULONG procid;

} KERNEL_SET_TARGET_REQUEST, *PKERNEL_SET_TARGET_REQUEST;
...
typedef struct _CLEARUNLOADEDDRIVERS
{
	NTSTATUS success;
} CLEARUNLOADEDDRIVERS, *PCLEARUNLOADEDDRIVERS;


typedef struct _COPY_MEMORY
{
	DWORD_PTR	localbuf;         // Buffer address
	DWORD_PTR	target_ptr;        // Target address
